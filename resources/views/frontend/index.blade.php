  ...
  <div class="container mt-5 mb-5 text-center">
      ...
      <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
              <div class="card">
                  <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                      <img src="assets/img/blog/blog-2.jpg" class="img-fluid blog-card" />
                  </div>
                  <div class="card-body">
                      <h5 class="card-title">Post title</h5>
                      <p class="card-text">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
              <div class="card">
                  <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                      <img src="assets/img/blog/blog-3.jpg" class="img-fluid blog-card" />
                  </div>
                  <div class="card-body">
                      <h5 class="card-title">Post title</h5>
                      <p class="card-text">
          ...
          <div class="col-md-12 mt-3 text-center">
              <a href="#" class="btn btn-blog-view text-white border-0 btn-md btn-arrow">
                  <span>All Blogs</span>
              </a>
          </div>
