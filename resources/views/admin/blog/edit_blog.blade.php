    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{ route('admin.update.blog') }}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="old_image" value="{{ $blogs->photo }}">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-xl"
                                            src="{{ !empty($blogs->photo) ? url($blogs->photo) : url('upload/no_image.jpg') }}"
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Blog Fotoğraf</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="title" value="{{ $blogs->title }}"
                                            type="text">
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Yayın Tarihi</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" name="date" value="{{ $blogs->date }}"
                                            type="date">
                                    </div>
                                </div>
                                <!-- end row -->
