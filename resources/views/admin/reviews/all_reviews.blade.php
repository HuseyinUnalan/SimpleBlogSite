                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($reviews as $item)
                                                    <tr class="odd">
                                                        ...
                                                        <td>
                                                            <a href="{{ route('admin.edit.review', $item->id) }}">
                                                                <button class="btn btn-primary btn-sm">
                                                                    <i class="far fa-edit"></i>
                                                                </button>
                                                            </a>

                                                            <a href="{{ route('admin.delete.review', $item->id) }}"
                                                                id="delete">
                                                            ...
                                                            @if ($item->status == 1)
                                                                <a href="{{ route('admin.review.inactive', $item->id) }}"
                                                                    class="btn btn-danger btn-sm"><i
                                                                        class="fa fa-arrow-down"
                                                                        title="Inactive Now"></i></a>
                                                            @else
                                                                <a href="{{ route('admin.review.active', $item->id) }}"
